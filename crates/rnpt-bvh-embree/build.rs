...
fn main() {
    ...
    if !embree_dir.exists() {
        ...
        eprintln!("[rnpt-bvh-embree] Downloading Embree {} ...", EMBREE_VERSION);
        ...
        eprintln!("[rnpt-bvh-embree] Extracting ...");
        ...
        let _ = fs::remove_file(&zip_path);
        eprintln!("[rnpt-bvh-embree] Embree ready at {}", embree_dir.display());
    }
